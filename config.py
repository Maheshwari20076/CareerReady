...
class Config:
    ...
    # --- MySQL connection (used with a local XAMPP / MySQL server) ---
    ...
    # Allows an explicit override (e.g. for automated testing) while the
    # normal project usage is always MySQL via the variables above.
